...
if uploaded_file is not None and uploaded_file2 is not None and uploaded_file3 is not None:
    ...
    result_wfo_associate,result_wfo_operation,result_wfo_division,result_wfo_location,result_wfo_designation,result_wfo_department = wfo1()
